...
![PNG](_static/4-13.png)

编辑完成后，点击确定即可。

![PNG](_static/4-10.png)

考生登录考试时填写信息界面如下图所示：

![PNG](_static/4-14.png)
...
![PNG](_static/04-01.png)

允许再次登陆：

![PNG](_static/04-03.png)

单元补时：

![PNG](_static/04-02.png)
